...
public class ActionsClassTest {
    ...
    String enableOptionLocator = "ui-id-3";
    String downloadOptionLocator = "ui-id-4";
    ...
    public void hoverTest3(){
        ...
        Actions action = new Actions(driver);
        WebElement enableElement = driver.findElement(By.id(enableOptionLocator));
        WebElement downloadElement = driver.findElement(By.id(downloadOptionLocator));
        WebElement pdfElement = driver.findElement(By.id(pdfOptionLocator));

        action.moveToElement(enableElement).
