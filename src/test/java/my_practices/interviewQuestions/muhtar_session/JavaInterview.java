package my_practices.interviewQuestions.muhtar_session;
...
public class JavaInterview {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        /*
         12.  Given a list of people’s names “Ahmed”,“John”,“Eric” ,
                write a java operation to remove all the names named “Ahmed”

         */
        // first way:
        List<String> name = new ArrayList<>(Arrays.asList("Ahmed","Ahmed","Yashar"));
        name.removeIf(p -> p.equals("Ahmed"));
        System.out.println(name);

        // second way:
        List<String> name2 = new ArrayList<>(Arrays.asList("Ahmed","Ahmed","Yashar"));
        ...
        name4.forEach(p-> {if(!p.equals("Ahmed")) name5.add(p);}  );
        ...
        /*
         13. Given a list of integers 1,2,3,4,5,6,... remove all values greater than 100
